...
//Funcões responsaveis por atribuir valores inseridos pelo usuario através do login:
function SendData() {
    dados_usuario.nome = document.getElementById('name').value;
    dados_usuario.senha = document.getElementById('password').value;
    sessionStorage.setItem('Nome', dados_usuario.nome)
    sessionStorage.setItem('Senha', dados_usuario.senha)
